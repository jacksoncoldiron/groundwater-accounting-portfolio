...
```{=html}
<h2 class="gw-eyebrow">2.1 The Accounting Lifecycle</h2>
...
::: {.gw-wide .gw-section}
```{=html}
<h2 class="gw-eyebrow">2.2 Key Findings</h2>
...
```{=html}
<h2 class="gw-eyebrow">2.3 Breakdown by Subbasin</h2>
```
...
that have not yet produced results — not every "not found" carries the same
weight.
:::
...
```{=html}
<h2 class="gw-eyebrow" style="color:var(--mlrp-light)">2.4 Connection to Accounting</h2>
```
...
::: {.gw-page .gw-section}
```{=html}
<h2 class="gw-eyebrow">2.5 Beyond</h2>
...
::: {.gw-page .gw-section}
```{=html}
<h2 class="gw-eyebrow">2.6 Further Exploration</h2>
```
...
```{=html}
<h2 class="gw-eyebrow">2.7 Geography</h2>
```
